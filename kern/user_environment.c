...
//	{
//		if (ptr_frame_info == 0) continue;
//		if (ptr_frame_info->environment->env_id == e->env_id) {
...
//	}
//
//	cprintf("asdasdasdasdasd2\n");
////	LIST_FOREACH(ptr_frame_info, &free_frame_list)
////	{
////		if (ptr_frame_info == 0) continue;
////		if (ptr_frame_info->environment->env_id == e->env_id) {
...
//		struct Frame_Info *ptr_frame_info = get_frame_info(e->env_page_directory, (void*)ws_virtual_address, &ptr_page_table);
//		if (ptr_frame_info != 0) {
//			free_frame(ptr_frame_info);
//		}
//
//		pt_clear_page_table_entry(e, ws_virtual_address);
//
//		unmap_frame(e->env_page_directory, (void* ) ws_virtual_address);
//
//		env_page_ws_clear_entry(e, i);
//	}
//
//	cprintf("asdasdasdasdasd4\n");
//	// [3] Free the PAGE working set itself from the main memory
//
//	kfree(e->ptr_pageWorkingSet);
//
//	// [4] Free all TABLES from the main memory
//	cprintf("asdasdasdasdasd5\n");
//	for (uint32 vaddr = 0; vaddr < 0xffffffff; vaddr += PAGE_SIZE * 1024) {
//		if (vaddr > 0xf1400000) break;
//		cprintf("vaddr %u\n", vaddr);
//		uint32* ptr_page_table = NULL;
//		get_page_table(e->env_page_directory, (void *) vaddr, &ptr_page_table);
//
//		if(ptr_page_table == NULL) continue;
//
//		kfree((void*)ptr_page_table);
//	}
//	cprintf("asdasdasdasdasd6\n");
