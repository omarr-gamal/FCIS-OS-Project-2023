...
void _main(void)
{
	...
	//[1] Allocate all
	{
		...
		ptr_allocations[0] = realloc(NULL, 1*Mega-kilo);
		...
		freeFrames = sys_calculate_free_frames() ;
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
		ptr_allocations[1] = realloc(NULL, 1*Mega-kilo);
		...
		freeFrames = sys_calculate_free_frames() ;
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
		ptr_allocations[2] = realloc(NULL, 1*Mega-kilo);
		...
		freeFrames = sys_calculate_free_frames() ;
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
		ptr_allocations[3] = realloc(NULL, 1*Mega-kilo);
		...
		freeFrames = sys_calculate_free_frames() ;
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
		ptr_allocations[4] = realloc(NULL, 2*Mega-kilo);
		...
		freeFrames = sys_calculate_free_frames() ;
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
		ptr_allocations[5] = realloc(NULL, 2*Mega-kilo);
		...
		freeFrames = sys_calculate_free_frames() ;
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
		ptr_allocations[6] = realloc(NULL, 3*Mega-kilo);
		...
		freeFrames = sys_calculate_free_frames() ;
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
		ptr_allocations[7] = realloc(NULL, 3*Mega-kilo);
		...
		ptr_allocations[8] = realloc(NULL, remainingSpaceInUHeap - kilo);
	...
	//[3] Test Re-allocation
	{
		...
		freeFrames = sys_calculate_free_frames() ;
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
		ptr_allocations[9] = realloc(NULL, 512*kilo - kilo);
		...
		freeFrames = sys_calculate_free_frames() ;
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
		ptr_allocations[9] = realloc(NULL, 1*Mega + 512*kilo - kilo);
